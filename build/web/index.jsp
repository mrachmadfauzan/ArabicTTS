        ...
        <div class="container" style="padding-top: 0">
            ...
            <div class="form-group">
                ...
                <button class="btn btn-link" onclick="
                    ...
                    document.getElementById('transliterasi').innerHTML = 'r/a/s/u/w//l/un/ //a/m/i/y//n/un/';
                        ">
                ...
                <button class="btn btn-link" onclick="
                    ...
                    document.getElementById('transliterasi').innerHTML = 'w/a/m/a/n// /m/m/a/&#96/a/h/u/';
                        ">
                ...
                <form target="_blank" name="textform" action="hasil.jsp" method="POST">
                    <div class="form-group">
                        <textarea id="karakter" name="karakter" class="form-control" rows="1" required></textarea>
            ...
            <div class="container">
                <p style="text-align: center">
                    ...
                    <button class="btn btn-info" type="button" id="1576" onclick="textFunction(1575, '')">&#1575<br><div style="font-size: 12px">(alif)</div></button>
                    ...
                    <button class="btn btn-info" type="button" id="1593" onclick="textFunction(1593, '&#96')">&#1593<br><div style="font-size: 12px">&#96(ng)</div></button>
            ...
            <div class="container">
                <div class="text-center">
                    <h4>Kami mengundang Bapak/Ibu/Saudara untuk mengisi survey penilaian aplikasi ini, pada link berikut.</h4>
                    <a href="pengujian/pengujian0.jsp"> <h3>Kuisioner</h3> </a>
                    <label>(13 pertanyaan)</label>
                </div>
            </div>
        </div>
    </body>
