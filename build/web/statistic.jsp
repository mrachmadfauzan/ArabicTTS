            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <p>Penilaian: </p>
                        <ol>
                            <li>Apakah identifikasi hukum bacaan sudah tepat?(Q1 = <label><%=df.format(q1)%></label>)</li>
                            ...
                            <li>Bagaimana penilaian Anda secara umum terhadap aplikasi ini?(Q5 = <label><%=df.format(q5)%></label>)</li>
                        </ol><!--//meta-->
                    </div>
                    <div class="col-sm-6">
