...
<%
    ...
    if (StringUtils.isNullOrEmpty(id) || StringUtils.isNullOrEmpty(ans11)) {
        ...
        try {
            ...
            String query = "update pengujian set ans11=? where id=?";
            ...
            if (updateQuery != 0) {
                ...
                response.sendRedirect("pengujian12.jsp?id="+id);
            }
