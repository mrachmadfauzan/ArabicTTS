...
<%
    ...
    if (StringUtils.isNullOrEmpty(id) || StringUtils.isNullOrEmpty(ans12)) {
        ...
        try {
            ...
            String query = "update pengujian set ans12=? where id=?";
            ps = conn.prepareStatement(query);
            ps.setString(1, ans12);
            ps.setString(2, id);
            updateQuery = ps.executeUpdate();
            if (updateQuery != 0) {
                //JOptionPane.showMessageDialog(null, "Berhasil Tambah Data");
                response.sendRedirect("pengujian13.jsp?id="+id);
            }
