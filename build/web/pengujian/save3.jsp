...
<%
    ...
    if (StringUtils.isNullOrEmpty(id) || StringUtils.isNullOrEmpty(ans3)) {
        ...
        try {
            ...
            String query = "update pengujian set ans3=? where id=?";
            ...
            if (updateQuery != 0) {
                ...
                response.sendRedirect("pengujian4.jsp?id="+id);
            }
