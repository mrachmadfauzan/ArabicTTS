...
<%
    ...
    if (StringUtils.isNullOrEmpty(id) || StringUtils.isNullOrEmpty(ans1)) {
        ...
        try {
            ...
            String query = "update pengujian set ans1=? where id=?";
            ...
            if (updateQuery != 0) {
                ...
                response.sendRedirect("pengujian2.jsp?id="+id);
            }
