...
<%
    ...
    if (StringUtils.isNullOrEmpty(id) || StringUtils.isNullOrEmpty(ans4)) {
        ...
        try {
            ...
            String query = "update pengujian set ans4=? where id=?";
            ...
            if (updateQuery != 0) {
                ...
                response.sendRedirect("pengujian5.jsp?id="+id);
            }
