...
<%
    ...
    if (StringUtils.isNullOrEmpty(id) || StringUtils.isNullOrEmpty(ans9)) {
        ...
        try {
            ...
            String query = "update pengujian set ans9=? where id=?";
            ...
            if (updateQuery != 0) {
                ...
                response.sendRedirect("pengujian10.jsp?id="+id);
            }
