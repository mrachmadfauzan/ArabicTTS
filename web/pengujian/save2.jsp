...
<%
    ...
    if (StringUtils.isNullOrEmpty(id) || StringUtils.isNullOrEmpty(ans2)) {
        ...
        try {
            ...
            String query = "update pengujian set ans2=? where id=?";
            ...
            if (updateQuery != 0) {
                ...
                response.sendRedirect("pengujian3.jsp?id="+id);
            }
